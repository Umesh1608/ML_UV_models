...
\begin{table}[t]
\centering
\caption{Cross-dataset benchmarking using published split protocols. $\dagger$Published results from original papers. Best result among our models in bold for each dataset. nablaColors uses a precomputed scaffold split~\cite{potapov2026nablacolors}.}
