...
This 61\% gap relative to RF is consistent with the hypothesis that Transformer representations are less sample-efficient for local properties on moderately-sized datasets, though ChemBERTa's superior wetlab generalization (Section~\ref{sec:wetlab}) suggests pretrained knowledge partially compensates.
