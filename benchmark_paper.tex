...
% --- Attention heatmap inset ---
\node[font=\tiny, anchor=south] at (2, -4.55) {Attention pattern:};
\foreach \r in {0,...,4} {
    \foreach \c in {0,...,4} {
        \pgfmathsetmacro{\vals}{ifthenelse(\r==0, ifthenelse(\c==0, 70, ifthenelse(\c==1, 50, ifthenelse(\c==2, 40, ifthenelse(\c==3, 20, 10)))), ifthenelse(\r==\c, 55, 12))}
        \fill[violet!\vals] (0.7+\c*0.25, -4.8-\r*0.25) rectangle ++(0.23, 0.23);
        \draw[gray!30, very thin] (0.7+\c*0.25, -4.8-\r*0.25) rectangle ++(0.23, 0.23);
    }
}
% CLS label
\node[font=\tiny, violet!70, rotate=90, anchor=south] at (0.55, -5.2) {[CLS]};
