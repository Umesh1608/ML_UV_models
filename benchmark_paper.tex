...
Our benchmark exploits this dichotomy, comparing fingerprint-based models (RF, XGBoost) against sequence-based models (BiGRU, ChemBERTa) on the same prediction task.
