...
\begin{figure*}[!ht]
    ...
    \node[box, fill=blue!12, draw=blue!40!black] (bigru) at (0, -0.6)
        {\textbf{BiGRU}\\[-1pt]{\scriptsize 2$\times$128 BiGRU, 470K params}};

    \node[box, fill=blue!12, draw=blue!40!black] (cb) at (0, -1.85)
    ...
    \node[font=\scriptsize\bfseries, blue!40!black, rotate=90, anchor=center,
          text width=, minimum height=0pt] at (-3.5, -1.225) {Sequence-based};
    ...
    \draw[arr, draw=blue!40!black]  (cb.east)     -- (3.6, -1.85) |- ([yshift=-7pt]out.west);
    % Inner pair (XGBoost / BiGRU): yshift ±2pt
    \draw[arr, draw=green!40!black] (xgb.east)    -- (3.6, 0.6)   |- ([yshift=2pt]out.west);
    \draw[arr, draw=blue!40!black]  (bigru.east)  -- (3.6, -0.6)  |- ([yshift=-2pt]out.west);
    ...
    % ---- Stage labels ----
    \node[font=\footnotesize\bfseries, gray!60, text width=, minimum height=0pt] at (0, -2.8) {\textsc{Models}};
