...
\begin{figure*}[!ht]
    ...
    % ---- Five models in three groups ----
    \node[box, fill=green!12, draw=green!40!black] (rf) at (0, 2.5)
        {\textbf{Random Forest}\\[-1pt]{\scriptsize 1000 trees, \texttt{max\_features}$= 0.3d$}};

    \node[box, fill=green!12, draw=green!40!black] (xgb) at (0, 1.25)
    ...
    \node[box, fill=blue!12, draw=blue!40!black] (bigru) at (0, -1.25)
        {\textbf{BiGRU}\\[-1pt]{\scriptsize 3$\times$256 BiGRU, 3.0M params}};

    \node[box, fill=blue!12, draw=blue!40!black] (cb) at (0, -2.5)
    ...
    \node[font=\scriptsize\bfseries, green!40!black, rotate=90, anchor=center,
          text width=, minimum height=0pt] at (-3.5, 1.875) {Fingerprint};
    ...
    \node[font=\scriptsize\bfseries, blue!40!black, rotate=90, anchor=center,
          text width=, minimum height=0pt] at (-3.5, -1.875) {Sequence};

    % ---- Dashed separators ----
    \draw[dashed, gray!30, thin] (-3.2, 0.625) -- (11.5, 0.625);
    \draw[dashed, gray!30, thin] (-3.2, -0.625) -- (11.5, -0.625);
    ...
    \draw[arr, draw=green!40!black] (rf.east)       -- (3.6, 2.5)   |- ([yshift=10pt]out.west);
    \draw[arr, draw=green!40!black] (xgb.east)      -- (3.6, 1.25)  |- ([yshift=5pt]out.west);
    \draw[arr, draw=red!40!black]   (chemprop.east) -- (3.6, 0)     |- (out.west);
    \draw[arr, draw=blue!40!black]  (bigru.east)    -- (3.6, -1.25) |- ([yshift=-5pt]out.west);
    \draw[arr, draw=blue!40!black]  (cb.east)       -- (3.6, -2.5)  |- ([yshift=-10pt]out.west);
