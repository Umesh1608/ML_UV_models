...
\begin{figure*}[!ht]
    ...
    \node[box, fill=green!12, draw=green!40!black] (rf) at (0, 3.2)
    ...
    \node[font=\scriptsize\bfseries, green!40!black, rotate=90, anchor=center,
          text width=, minimum height=0pt] at (-3.5, 2.4) {Fingerprint};
    ...
    \node[font=\scriptsize\bfseries, blue!40!black, rotate=90, anchor=center,
          text width=, minimum height=0pt] at (-3.5, -2.4) {Sequence};
    ...
    \draw[arr, draw=green!40!black] (rf.east)       -- (3.6, 3.2)   |- ([yshift=12pt]out.west);
    ...
    % ---- Stage labels ----
    \node[font=\footnotesize\bfseries, gray!60, text width=, minimum height=0pt] at (0, -4.1) {\textsc{Models}};
    \node[font=\footnotesize\bfseries, gray!60, text width=, minimum height=0pt] at (8.0, -3.8) {\textsc{Prediction}};
