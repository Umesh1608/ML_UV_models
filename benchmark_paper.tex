...
% Invisible spacers to match height of (b) and (c)
\node[below=1.35cm of out, minimum height=0.85cm] (sp1) {};
\node[below=1.35cm of sp1, minimum height=0.85cm] (sp2) {};
\node[below=1.35cm of sp2, minimum height=0.85cm] (sp3) {};
\end{tikzpicture}
