...
\begin{figure*}[!ht]
    ...
    \node[box, fill=blue!12, draw=blue!40!black] (cb) at (0, -1.95)
    ...
    \node[font=\scriptsize\bfseries, blue!40!black, rotate=90, anchor=center,
          text width=, minimum height=0pt] at (-3.5, -1.325) {Sequence-based};
    ...
    \draw[arr, draw=blue!40!black]  (cb.east)     -- (3.6, -1.95) |- ([yshift=-7pt]out.west);
