...
% ===== Abstract =====
\begin{abstract}
Which machine learning model should a chemist choose for predicting UV absorption wavelengths?
We benchmark five approaches---Random Forest (RF), XGBoost, Chemprop (D-MPNN), a Bidirectional GRU (BiGRU), and ChemBERTa---spanning fingerprint, graph, recurrent, and Transformer architectures on 18,755 solute--solvent pairs with stratified 5-fold cross-validation and two external datasets totaling over 40,000 molecules.
