...
\begin{figure*}[!ht]
    ...
    \node[box, fill=blue!12, draw=blue!40!black] (bigru) at (0, -2.0)
        {\textbf{BiGRU RNN}\\[-1pt]{\scriptsize 3$\times$256 bidirectional GRU, 3.0M params}};

    \node[box, fill=blue!12, draw=blue!40!black] (cb) at (0, -3.6)
    ...
    \node[font=\scriptsize\bfseries, blue!40!black, rotate=90, anchor=center,
          text width=, minimum height=0pt] at (-3.5, -2.8) {Sequence};

    % ---- Output box ----
    \node[box, fill=orange!8, draw=orange!50!black, text width=2.0cm,
          minimum height=3.4cm] (out) at (6.8, -0.2)
    ...
    \draw[arr, draw=blue!40!black]  (bigru.east)    -- (3.6, -2.0)  |- ([yshift=-6pt]out.west);
    \draw[arr, draw=blue!40!black]  (cb.east)       -- (3.6, -3.6)  |- ([yshift=-12pt]out.west);
    ...
    % ---- Stage labels ----
    \node[font=\footnotesize\bfseries, gray!60, text width=, minimum height=0pt] at (0, -4.5) {\textsc{Models}};
    \node[font=\footnotesize\bfseries, gray!60, text width=, minimum height=0pt] at (8.0, -4.2) {\textsc{Prediction}};
