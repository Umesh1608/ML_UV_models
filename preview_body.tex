...
\begin{table}[htbp]
\centering
\caption{Model comparison on the Joung+Beard dataset (18,755 samples, stratified 5-fold CV, 64/16/20 split). Best values in bold. $\pm$ = std across folds.}
...
\midrule
RF              & \textbf{31.3\,{\scriptsize$\pm$\,1.8}} & \textbf{15.2\,{\scriptsize$\pm$\,0.4}} & \textbf{.914\,{\scriptsize$\pm$\,.010}} & \textbf{.956\,{\scriptsize$\pm$\,.005}} \\
Chemprop        & 31.7\,{\scriptsize$\pm$\,3.2}          & 16.8\,{\scriptsize$\pm$\,1.7}          & .911\,{\scriptsize$\pm$\,.016}          & .955\,{\scriptsize$\pm$\,.009} \\
XGBoost         & 33.7\,{\scriptsize$\pm$\,1.6}          & 20.1\,{\scriptsize$\pm$\,0.5}          & .900\,{\scriptsize$\pm$\,.009}          & .950\,{\scriptsize$\pm$\,.005} \\
BiGRU (tuned)   & 34.7\,{\scriptsize$\pm$\,1.4}          & 18.1\,{\scriptsize$\pm$\,0.6}          & .894\,{\scriptsize$\pm$\,.009}          & .946\,{\scriptsize$\pm$\,.005} \\
BiGRU (default) & 36.5\,{\scriptsize$\pm$\,1.1}          & 20.7\,{\scriptsize$\pm$\,0.5}          & .884\,{\scriptsize$\pm$\,.006}          & .940\,{\scriptsize$\pm$\,.003} \\
XGB (MAE)       & 40.8\,{\scriptsize$\pm$\,1.6}          & 22.0\,{\scriptsize$\pm$\,0.5}          & .854\,{\scriptsize$\pm$\,.010}          & .927\,{\scriptsize$\pm$\,.005} \\
ChemBERTa       & 50.4\,{\scriptsize$\pm$\,2.3}          & 24.3\,{\scriptsize$\pm$\,1.0}          & .777\,{\scriptsize$\pm$\,.019}          & .899\,{\scriptsize$\pm$\,.009} \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{table}[htbp]
\centering
\caption{Effect of solvent information (stratified 5-fold CV). All values in nm except $R^2$ and $r$.}
...
\textbf{Model} & \textbf{RMSE} & \textbf{MAE} & $\boldsymbol{R^2}$ & $\boldsymbol{r}$ \\
\midrule
RF + Solvent       & \textbf{31.3\,{\scriptsize$\pm$\,1.8}} & \textbf{15.2\,{\scriptsize$\pm$\,0.4}} & \textbf{.914} & \textbf{.956} \\
RF Solute only     & 34.1\,{\scriptsize$\pm$\,1.4}          & 16.5\,{\scriptsize$\pm$\,0.3}          & .898          & .948 \\
\midrule
Chemprop + Solv.   & 31.7\,{\scriptsize$\pm$\,3.2}          & 16.8\,{\scriptsize$\pm$\,1.7}          & .911          & .955 \\
Chemprop only      & 33.8\,{\scriptsize$\pm$\,2.7}          & 16.5\,{\scriptsize$\pm$\,0.6}          & .900          & .949 \\
\midrule
BiGRU + Solvent    & 36.5\,{\scriptsize$\pm$\,1.1}          & 20.7\,{\scriptsize$\pm$\,0.5}          & .884          & .940 \\
BiGRU Solute only  & 39.0\,{\scriptsize$\pm$\,1.4}          & 22.5\,{\scriptsize$\pm$\,0.3}          & .866          & .931 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{tabular}{@{}llccc@{}}
\toprule
\textbf{Dataset} & \textbf{Model} & \textbf{RMSE} & \textbf{MAE} & $\boldsymbol{R^2}$ \\
\midrule
\multirow{5}{*}{\shortstack[l]{Deep4Chem\\(80/10/10)}}
  & GCNN$^\dagger$   & 26.6           & ---            & ---   \\
  & Chemprop         & \textbf{19.1}  & \textbf{10.7}  & \textbf{.967} \\
  & RF               & 22.7           & 11.3           & .954 \\
  & ChemBERTa        & 35.9           & 17.4           & .884 \\
  & BiGRU            & 27.1           & 17.2           & .934 \\
\midrule
\multirow{7}{*}{\shortstack[l]{Jung 2024\\(72/18/10)}}
  & MF$^\dagger$     & 31.3           & 14.6           & .91  \\
  & GBFS$^\dagger$   & 32.2           & 16.2           & .91  \\
  & DR-CNN$^\dagger$ & 44.4           & 23.3           & .82  \\
  & Chemprop         & \textbf{27.4}  & \textbf{15.5}  & \textbf{.936} \\
  & RF               & 29.8           & 15.3           & .924 \\
  & ChemBERTa        & 38.3           & 19.3           & .874 \\
  & BiGRU            & 36.3           & 21.5           & .887 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\columnwidth]{results/rf_cumulative_importance.png}
...
\begin{table}[htbp]
\centering
\caption{Photosafety classification. $^\dagger$Published on original Reaxys data; our models use reconstructed version (93.6\% recovery).}
\label{tab:classification}
\footnotesize
\setlength{\tabcolsep}{3pt}
\begin{tabular}{@{}lccccc@{}}
\toprule
\textbf{Model} & $\boldsymbol{N}$ & \textbf{Sens.} & \textbf{Spec.} & \textbf{Acc.} & \textbf{AUC} \\
\midrule
Mamede$^\dagger$ & 998   & .90  & .88  & .89  & --- \\
Our RF           & 1996  & .876 & .882 & .879 & .942 \\
BiGRU cls        & 1996  & .794 & .811 & .803 & .886 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{table}[htbp]
\centering
\caption{Aggregate wetlab validation (16 mol.\ $\times$ 2 solvents = 32 points). 95\% bootstrap CIs in brackets.}
\label{tab:wetlab_summary}
\footnotesize
\setlength{\tabcolsep}{3pt}
\begin{tabular}{@{}lcc@{}}
\toprule
\textbf{Model} & \textbf{MAE (nm)} & \textbf{RMSE (nm)} \\
\midrule
Chemprop    & \textbf{26.2}         & 35.7 \\
ChemBERTa   & 26.3 {\scriptsize[20--33]}  & \textbf{32.2} {\scriptsize[25--39]} \\
BiGRU (def.)& 28.6 {\scriptsize[23--35]}  & 33.9 {\scriptsize[26--41]} \\
BiGRU (tun.)& 31.5                  & 37.0 \\
RF          & 38.5 {\scriptsize[32--46]}  & 43.7 {\scriptsize[35--52]} \\
\bottomrule
\end{tabular}
\end{table}
