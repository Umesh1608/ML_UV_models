...
\begin{suppinfo}
Per-fold cross-validation results for all four model families (Tables S1--S4), statistical significance tests (Table S5), RF hyperparameter sensitivity analysis, BiGRU and ChemBERTa learning curves, hyperparameter tuning asymmetry analysis, and BiGRU character-type saliency analysis. Available as a separate PDF.
\end{suppinfo}
