...
BiGRU Solute only        & $\sim$38.42 $\pm$ 0.70 & $\sim$22.41 $\pm$ 0.23 & $\sim$0.870 & --- \\
...
\begin{enumerate}
    \item \TODO{Table 2 (Solvent Ablation): BiGRU Solute only row is ``---''. Fill in after BiGRU no-solvent v2 fold 4 completes (currently running). Estimated values: RMSE $\sim$38.4, MAE $\sim$22.4. Solvent improvement $\sim$5\%.}
    \item \TODO{Abstract line: ``and X\% for BiGRU'' --- replace X with actual percentage once BiGRU no-solvent v2 is complete. Estimated $\sim$5\%.}
\end{enumerate}
...
\begin{enumerate}[leftmargin=*]
    ...
    \TODO{Waiting for BiGRU no-solvent v2 to complete (fold 4 running). Estimated $\sim$5\% improvement with solvent encoding.}
\end{enumerate}
...
\begin{enumerate}
    ...
    \item[\TODO{}] Fill in BiGRU no-solvent v2 numbers (Table 2 + abstract)
